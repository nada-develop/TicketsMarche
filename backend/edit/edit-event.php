...
$conn = mysqli_connect('localhost', 'root', '', 'ticketsmarchgroupb');
 if(isset($_POST['name'])){
    ...
    $q = "UPDATE events SET ename = '$name', elocation = '$location', eplace = '$place', ecategory = '$category', pfrom = '$fprice', pto = '$tprice', dfrom = '$dfrom', dto = '$dto', img = '$image', imgs = '$images' WHERE id = '$id'";
...
<body>
    <form action="edit-event.php" method="post" enctype="multipart/form-data" class="edit-form">
        <h2>edit Event</h2>
        ...
        <a href="../list/event-list.php"><button type="button" name="button">Event List</button></a>
        <section class="fix"></section>
    </form>
